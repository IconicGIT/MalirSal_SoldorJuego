...
bool BatEnemy::Start()
{
	...
	idle.PushBack({ 0, 48 * 1, 48, 48 });
	idle.PushBack({ 48 * 1, 48 * 1, 48, 48 });
	idle.PushBack({ 48 * 2, 48 * 1, 48, 48 });
	idle.PushBack({ 48 * 3, 48 * 1, 48, 48 });
	idle.PushBack({ 48 * 4, 48 * 1, 48, 48 });
	idle.PushBack({ 48 * 5, 48 * 1, 48, 48 });
	idle.PushBack({ 48 * 6, 48 * 1, 48, 48 });
	idle.PushBack({ 48 * 7, 48 * 1, 48, 48 });
	idle.speed = 0.15f;
...
bool BatEnemy::LoadState(pugi::xml_node&)
{
	return false;
}
bool BatEnemy::SaveState(pugi::xml_node&) const
{
	return false;
}
...
int BatEnemy::Attack(int enemyType)
{
	return 0;
}
